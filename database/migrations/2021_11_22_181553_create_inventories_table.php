...
class CreateInventoriesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('inventories', function (Blueprint $table) {
            ...
            $table->string('vin',253)->nullable()->default(null)->comment('VIN');
            ...
            $table->string('exterior_color',50)->nullable()->default(null)->comment('Color Exterior');
            $table->string('interior_color',50)->nullable()->default(null)->comment('Color Interior');
            ...
            $table->timestamp('last_updated', $precision = 0)->nullable()->default(now())->comment('Ultima actualizacion');
